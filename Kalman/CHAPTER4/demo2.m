...
subplot(2,1,1),plot(t,x1,'b',t,xa1,'y');xlabel('Time (sec)');ylabel('Position');title('Example 4.3: True (blue) and approx. (yel) state dynamics');
subplot(2,1,2),plot(t,x2,'b',t,xa2,'y');xlabel('Time (sec)');ylabel('Velocity');
pause
%
...
disp(' ');
disp('Press <ENTER> key to continue');
subplot(2,1,1),plot(tm,s1,'b',tm,sa1,'y');xlabel('Time (sec)');ylabel('RMS Pos.');title('Example 4.3: Uncertainties, true (blue) and approx. (yel)');
subplot(2,1,2),plot(tm,s2,'b',tm,sa2,'y');xlabel('Time (sec)');ylabel('RMS Vel.');
pause
disp(' ');
...
disp(' ');
subplot(2,1,1),plot(t,x1,'b',t,z,'r',tm,xh1,'c',tm,xha1,'y');xlabel('Time (sec)');ylabel('Position');title('True (blu), estim. (lt.blu) est/approx (yel) & meas. (red) states');
subplot(2,1,2),plot(t,x2,'b',tm,xh2,'c',tm,xha2,'y');xlabel('Time (sec)');ylabel('Velocity');
