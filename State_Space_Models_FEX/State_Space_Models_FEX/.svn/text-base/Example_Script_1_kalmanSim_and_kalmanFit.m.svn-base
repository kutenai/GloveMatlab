...
%
% This script will first simulate a state space model using kalmanSim.m with 1 regressor and
% then fit it using the fitting function (kalmanFit.m)
% In non matrix notation, the model in this particular example is:
%
% y(t) = b_1(t)*x_1(t) + e(t)     
% b_1(t)= .5 + .5*b_1(t-1) + v_1(t)     
%
% e(t)  ~ N(0,1)
% v_1(t)~ N(0,.1)
...
Coeff.F=.5;     % F coefficient at beta equation
Coeff.Q=.1;     % variance of residue at beta equation
