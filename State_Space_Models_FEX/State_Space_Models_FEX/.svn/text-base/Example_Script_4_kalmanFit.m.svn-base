% Example Script #4 for kalmanFit()
%
...
% v_2(t)~N(0,Q_2)
%
% where the estimated coefficients are u_1, u_2, F-2, R, Q_1 and Q_2
...
optionsSpec.u_D={'e' 'e'};      % either 0 or 'e' ('e' is the "estimate" tag) 
optionsSpec.F_D={ 0  'e'};      % either 1, 0 or 'e' ('e' is the "estimate" tag) 
